...
**TLDR**; You will be graded for presenting homework exercises (hereafter referred to as "proofs") in section or to a classmate who has done them. You must **use prooflogger to keep a record of proofs that you present**. You must post to <http://198.58.99.58/> by Thursday before the end of your recitation period, each week we meet.
