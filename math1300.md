...
Include the appropriate `#week_number` hashtag and mention `@username` the person(s) who you presented your proof to. You should include this data:
...
At the bottom of each page (and by each post), there's a link to "Report this". Please use it.

Prooflogger is an extension of the classroom. I will tolerate neither honor code violations nor harassment.
