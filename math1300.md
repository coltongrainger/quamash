...
- If you can stomach a timed practice exam, then go find an "exam 2" in the APPM 1350  [ exam archive ]( https://www.colorado.edu/amath/academics/exam-archives/appm-1350-exam-archive ). 
    ...
    - I recommend skimming through the calculus exams from APPM because, since 2010-ish, *most all* of their undergraduate courses have exams that are [nicely typed up](https://en.wikipedia.org/wiki/TeX) ("$\mathrm\TeX$'d"), with solutions also available online. 

- Else, do feel free to pursue the following material:
