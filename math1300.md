...
Include the appropriate `#week_number` hashtag and mention `@username` the one person who you presented your proof to. You should include this data:
...
Here a few comments from my Fall 2018 student evaluations. Following the example set by [Kate Stange](https://math.colorado.edu/~kstange/evals-brown-comments.html) I have included negative comments also, and tried to give a representative cross-section.
