...
The bottom left of each page (and each post) has a link to "Report this". Feel free to use it. (Prooflogger is an extension of the classroom. I will tolerate neither honor code violations nor harassment.)

### What type of software is prooflogger?

Prooflogger is a multi-user "microblog" served PHP, MariaDB, and [Elgg](https://elgg.org/) from a [linode](https://www.linode.com/) machine registered to Colton Grainger.
