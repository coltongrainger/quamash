...
FACT! Evaluated at any of the $n+1$ generating points $x_i$, the Lagrange $k$th polynomial is equal to ... the Kroenecker delta $$\delta_{ik} = \bigg\{ \begin{align} 1 &\text{ if } i=k\\ 0 &\text{ else.} \end{align}$$
