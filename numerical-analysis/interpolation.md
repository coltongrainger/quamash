...
DEF! (Lagrange form) Let $f \in C[a,b]$, and specify $n+1$ distinct points $x_i$. The interpolating polynomial in Lagrange form is $p_n \in \mathcal{P}_n$ where ... $$p_n(x) = \sum_{k=0}^n f(x_k) l_k(x).$$
