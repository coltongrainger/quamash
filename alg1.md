...
#### Ideals, etc --- broken wrist

Oh no! Broke my wrist. I'm not taking notes for a bit. Here's a bit from google's voice to text.
...
> 
> In topology,  we showed a regular space with a countable basis is normal. We showed  that a compact hausdorff space  is normal. Lastly Robin presented the idea for a proof of Urysohn’s Lemma. Which provides a connection between  normal topological spaces  and functions which are continuous out of them.
> 
